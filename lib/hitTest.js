 ...
 * @return {RenderLayer}
 */
function hitTest (e, rootLayer, rootNode, surface) {
  ...
  console.log(index++);
  if (surface.activeLayer !== layer) {
    if (surface.activeLayer && surface.activeLayer.onMouseLeave) surface.activeLayer.onMouseLeave(e);
    if (layer && layer.onMouseEnter) layer.onMouseEnter(e);
    surface.activeLayer = layer;
  }
