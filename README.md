...
We needed to use React and ReactCanvas in a project without dependecy management system so this file exposes these to window.

Run `npm run export` to build production version.
